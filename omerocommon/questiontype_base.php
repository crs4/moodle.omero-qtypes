...
abstract class qtype_omerocommon extends qtype_multichoice
{
    ...
    public function save_question($question, $form)
    {
        ...
        //echo "<br><br>SAving question: ";
        //print_r($question);
        //echo "<br>";
        //print_r($form);
        //echo "<br><br>SAving question END!!!! ";

        $question = parent::save_question($question, $form); // TODO: Change the autogenerated stub
        if ($question) {

            //echo "Updating question";
            $question->questiontext = $form->questiontext_locale_map;
            $question->generalfeedback = $form->generalfeedback_locale_map;
